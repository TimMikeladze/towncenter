...
export const getAllUnits = cache(async (): Promise<Unit[]> => {
  ...
  const reader = await conn.runAndReadAll(`
    ...
    GROUP BY u.id, u.internal_name, u.hp, u.attack, u.range, u.min_range,
             ...
             u.attack_delay_seconds, u.train_time, u.blast_width, u.max_charge,
             u.recharge_rate, u.recharge_duration, u.charge_event, u.charge_type,
             u.trait, u.trait_piece, u.cost_food, u.cost_wood,
