...
/** The public source repo, linked from the header and the about page. */
export const REPO_URL = "https://github.com/TimMikeladze/towncenter"
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/tech-tree", label: "Tech Tree", description: "What a civ can train, build and research", icon: Network },
  {
    href: "/counters",
    label: "Counters",
    description: "Computed matchups from attack, armor and cost",
    icon: Shield,
  },
  {
    href: "/battle",
...
/**
 * Also not a section: the page that says who made this and where the numbers
 * come from. It rides along at the end of the rail and the "More" sheet.
 */
export const ABOUT_ITEM: NavItem = {
  href: "/about",
  label: "About",
  description: "Who built this, and where the data comes from",
  icon: Info,
}
