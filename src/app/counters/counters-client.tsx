...
export function CountersClient({ units, unit, goodAgainst, counteredBy }: CountersClientProps) {
  ...
  return (
    <PageShell width="default">
      ...
      <DerivedNote>
        These matchups are this site's own model, not values from the game files. Damage per hit is resolved class by
        class against the defender's armour, turned into DPS with reload time and projectile accuracy, then weighted by
        resource cost (gold and stone counted at 1.5&times; food and wood). A trade has to be 1.5&times; lopsided before
        it is listed.
      </DerivedNote>
