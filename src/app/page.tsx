      ...
      <section className="panel overflow-hidden">
        <div className="space-y-4 border-b px-4 py-6 sm:space-y-5 sm:px-8 sm:py-12">
          ...
          <h1 className="max-w-3xl text-[28px] leading-[1.15] sm:text-4xl lg:text-5xl">
            Look up anything mid-game, settle it before the fight
          </h1>
          <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
            Units, civs, buildings, techs and full tech trees in one place — search it, compare it, simulate the fight,
            and see what the last patch changed.
          </p>
          {/*
